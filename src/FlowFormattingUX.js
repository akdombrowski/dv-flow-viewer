            ...
            <Form className="p-0 m-0">
              <Row
                ...
                <Col
                  id="nodeSpacingCol"
                  xs={12}
                  className="p-0 pt-3 m-0">
                  <Row
                    id="nodeSpacingInputGroupRow"
                        ...
                        <Row className="w-100 p-0 m-0">
                          ...
                          <Col
                            ...
                            <Form.Control
                              ...
                              className="h-100 fs-6 text-center p-0 m-0 rounded-0 border-secondary"></Form.Control>
                          </Col>
                        </Row>
                      </InputGroup>
                    </Col>
                ...
                <Col
                  xs={12}
                  className="p-0 pb-3 m-0 d-flex flex-column">
                  <Row className="m-0 p-0">
                    <Col
                      xs={10}
                      className="m-0 p-0"></Col>
